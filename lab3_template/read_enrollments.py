...
learners =course.learners.all() #<HINT> use the learners field in Course model# 
print(learners)
...
for course in courses:
    for learner in course.learners.all(): #<HINT>use the learners field in Course Model#  :
